...
#     # On frames after the 2nd, update the geometry
#     if count > 2:
...
#     #print(lidar_3d.shape) # debug_1114
#     #print(projected_lidar.shape) # debug_1114
#     for i in range(yolo_bbx.shape[0]):
#         # --- START FIX: Wrap entire loop logic in try...except ---
#         # This catches any errors (scalars, empty arrays) from a
#         # specific object and just skips it, preventing a crash.
#         try:
...
#             # If any error occurs (e.g., scalar indexing, type mismatch)
#             # just skip this bounding box and continue to the next one.
#             continue
#         # --- END FIX ---
...
# # def save_point_cloud_data(count, point_cloud, save_dir="lidar_data"):
# #     """
