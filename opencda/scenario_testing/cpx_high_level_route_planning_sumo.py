# -*- coding: utf-8 -*-
"""Ported scenario: ``opencda_scenario/high_level_route_planning_sumo``.
...
def run_scenario(opt, scenario_params):
    run_legacy_scenario_port(
        ...
        legacy_scenario_name="high_level_route_planning_sumo",
        script_name="cpx_high_level_route_planning_sumo",
    )
