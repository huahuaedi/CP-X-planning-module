# -*- coding: utf-8 -*-
"""Ported scenario: ``carla_scenario/mdrive_pedestrian_crosswalk_1``.
...
def run_scenario(opt, scenario_params):
    run_legacy_scenario_port(
        ...
        legacy_scenario_name="mdrive_pedestrian_crosswalk_1",
        script_name="cpx_mdrive_pedestrian_crosswalk_1",
    )
