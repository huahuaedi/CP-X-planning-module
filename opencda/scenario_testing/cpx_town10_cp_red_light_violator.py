# -*- coding: utf-8 -*-
"""Ported scenario: ``opencda_scenario/town10_cp_red_light_violator``.
...
def run_scenario(opt, scenario_params):
    run_legacy_scenario_port(
        ...
        legacy_scenario_name="town10_cp_red_light_violator",
        script_name="cpx_town10_cp_red_light_violator",
    )
