"""
Scenario-local logic for town6_scenario_1.
"""
...
SCENARIO_NAME = "town6_scenario_1"
DEFAULT_CP_MESSAGE_PATH = base.DEFAULT_CP_MESSAGE_PATH


def _info(message: str) -> None:
    print(f"[TOWN6 SCENARIO 1] {message}")


def _warning(message: str) -> None:
    print(f"[TOWN6 SCENARIO 1] Warning: {message}")
    ...
    *,
    ...
    for vru_state in vru_states:
        ...
        walker_actor, _controller_actor = base._spawn_vru(
            ...
            role_name=str(vru_state.get("role_name", "town6_scenario_1_vru")),
