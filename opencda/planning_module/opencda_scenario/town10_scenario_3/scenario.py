"""
Scenario-local logic for town10_scenario_3.
"""
...
SCENARIO_NAME = "town10_scenario_3"
DEFAULT_CP_MESSAGE_PATH = base.DEFAULT_CP_MESSAGE_PATH


def _info(message: str) -> None:
    print(f"[TOWN10 SCENARIO 3] {message}")


def _warning(message: str) -> None:
    print(f"[TOWN10 SCENARIO 3] Warning: {message}")
    ...
    *,
    ...
    for vru_state in vru_states:
        ...
        walker_actor, _controller_actor = base._spawn_vru(
            ...
            role_name=str(vru_state.get("role_name", "town10_scenario_3_vru")),
