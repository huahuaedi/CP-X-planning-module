...
_BOOTSTRAPPED_INSTALL_ROOT: Optional[Path] = None
_AD_MAP_MODULE = None
...
def resolve_ad_map_install_root(ad_map_install_root: Optional[Union[str, Path]] = None) -> Path:
...
def prepare_ad_map_runtime(ad_map_install_root: Optional[Union[str, Path]] = None) -> Path:
...
def import_ad_map_access(ad_map_install_root: Optional[Union[str, Path]] = None):
